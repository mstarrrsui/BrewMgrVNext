...
module.exports = {
  ...
  "entry": {
    ...
    "styles": [
      ...
      "./node_modules\\toastr\\build\\toastr.css",
      "./src\\css\\styles.css"
    ]
  },
  "output": {
    "path": path.join(process.cwd(), "..\\BrewMgrCore\\wwwroot"),
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src\\css\\bootstrap\\bootstrap.css"),
          path.join(process.cwd(), "node_modules\\font-awesome\\css\\font-awesome.css"),
          path.join(process.cwd(), "node_modules\\toastr\\build\\toastr.css"),
  ...
  "plugins": [
    ...
    new ConcatPlugin({
      ...
      "fileName": "[name].bundle.js",
      "filesToConcat": [
        "D:\\github\\BrewMgrVNext\\src\\BrewMgrAngular\\node_modules\\jquery\\dist\\jquery.js",
    ...
    new CopyWebpackPlugin([
      {
        "context": "D:\\github\\BrewMgrVNext\\src\\BrewMgrAngular\\src/",
        "to": "",
        "from": {
          "glob": "assets/**/*",
          "dot": true
